...
#ifndef LANG_RUSSIAN_H
#define LANG_RUSSIAN_H

// Set alternate character set

#define ALTCHARSET "CP1251"
...
#define NAME				"Unizone (Русский)"				// Application Title

#define MSG_CSTATUS			"Статус:"
#define MSG_CSERVER			"Сервер:"
#define MSG_CNICK			"Nick:"

#define MSG_CONNECTING      "Соединение с сервером %1."
#define MSG_CONNECTFAIL		"Соединение с сервером не удалось!"
#define MSG_CONNECTED       "Соединение установлено."
#define MSG_DISCONNECTED	"Отключен от сервера."
#define MSG_NOTCONNECTED    "Нет соединения."
#define MSG_RESCAN          "Обновление информации о доступных файлах..."
#define MSG_SCAN_ERR1		"Повторное сканирование!"
#define MSG_NOTSHARING		"Не разрешен доступ к локальным файлам."
#define MSG_NONICK			"Никнэйм занят."
#define MSG_NOMESSAGE		"Сообщение не отослано."
#define MSG_AWAYMESSAGE		"Недоступен с %1."
#define MSG_HEREMESSAGE		"Доступен с  %1."
#define MSG_UNKNOWNCMD		"Неизвстная комманда!"
#define MSG_NOUSERS			"Не выбран пользователь."
#define MSG_NO_INDEX		"No index specified."
#define MSG_INVALID_INDEX	"Ошибка индексирования."
#define MSG_USERSNOTFOUND   "Пользователь не найден!"
...
#define MSG_SCANSHARES		"Сканирование локальных файлов..."
#define MSG_SHARECOUNT		"Доступно локальных файлов %1 file(s)."
#define MSG_NAMECHANGED		"Никнэйем сменен на <font color=\"%2\">%1</font>."
...
#define MSG_HERE			"Здесь"
#define MSG_AWAY			"Недоступен"
#define MSG_STATUS_IDLE		"idle"
#define MSG_STATUS_BUSY		"Занят"
#define MSG_AT_WORK			"Работаю"
#define MSG_AROUND			"around"
#define MSG_SLEEPING		"Дремаю"
//
// Menus
//
...
#define MSG_PR_PREFERENCES		"Настройки"

// Tab names

#define MSG_GENERAL				"Основные"
#define MSG_CONNECTION			"Соединение"
#define MSG_DISPLAY				"Экран"
#define MSG_COLORS				"Цвета"
#define MSG_STYLE				"Оформление"
...
#define MSG_2_MINUTES		"2 Минуты"
#define MSG_5_MINUTES		"5 Минут"
#define MSG_10_MINUTES		"10 Минут"
#define MSG_15_MINUTES		"15 Минут"
#define MSG_20_MINUTES		"20 Минут"
#define MSG_30_MINUTES		"30 Минут"
#define MSG_1_HOUR			"1 Час"
#define MSG_2_HOURS			"2 Часа"
