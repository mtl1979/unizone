...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "..\src\qt3" /I "..\..\src" /I "..\..\src\qt3" /I "c:\qt3\include" /I "..\..\..\libjpeg" /I "..\..\..\src" /I "..\..\src\muscle" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "UNICODE" /D "QT_DLL" /D "QJPEG_STATIC" /FR /YX /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib qt-mt3.lib qtmain.lib /nologo /subsystem:windows /machine:I386 /nodefaultlib:"msvcrtd.lib" /libpath:"c:\qt3\lib" /libpath:"..\..\libjpeg\Release"
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "..\..\src" /I "..\..\src\qt3" /I "c:\qt3\include" /I "..\..\..\libjpeg" /I "..\..\..\src" /I "..\..\src\muscle" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "UNICODE" /D "QT_DLL" /D "QJPEG_STATIC" /FR /YX /FD /GZ /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib qt-mt3.lib qtmain.lib /nologo /subsystem:windows /debug /machine:I386 /nodefaultlib:"msvcrt.lib" /pdbtype:sept /libpath:"c:\qt3\lib" /libpath:"..\..\libjpeg\Debug"
...
SOURCE=..\..\src\qt3\moc_mainwindow.cpp
# End Source File
# Begin Source File

SOURCE=..\..\src\qt3\moc_mainwindowimpl.cpp
# End Source File
# Begin Source File
...
SOURCE=..\..\src\qt3\moc_previewimpl.cpp
# End Source File
# Begin Source File
...
BuildCmds= \
	%qtdir%\bin\uic.exe $(InputPath) -o $(InputDir)\qt3\$(InputName).h \
	%qtdir%\bin\uic.exe $(InputPath) -i $(InputName).h -o $(InputDir)\qt3\$(InputName).cpp \
...
SOURCE=..\..\src\qt3\mainwindow.h

!IF  "$(CFG)" == "Image Splitter - Win32 Release"

# Begin Custom Build - Moc'ing $(InputName).h ...
InputDir=\build\unizone\isplitter\src\qt3
InputPath=..\..\src\qt3\mainwindow.h
InputName=mainwindow
