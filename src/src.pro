...
DEFINES += MUSCLE_ENABLE_ZLIB_ENCODING MUSCLE_ENABLE_QTHREAD_EVENT_LOOP_INTEGRATION
!isEmpty(SSL_DIR) {
...
win32 {
	DEFINES += WIN32_LEAN_AND_MEAN UNICODE _UNICODE REGEX_USEDLL MUSCLE_PREFER_QT_OVER_WIN32
